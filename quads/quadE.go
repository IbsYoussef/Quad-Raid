...
//
// Character mapping:
//   'A' = Top-left corner, Bottom-right corner
//   'C' = Top-right corner, Bottom-left corner
//   'B' = All other edges
//   ' ' = Interior spaces

// QuadE prints a rectangle with:
// - 'A' at top-left and bottom-right corners
// - 'C' at top-right and bottom-left corners
